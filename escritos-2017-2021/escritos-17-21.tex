...
\begin{document}
	...
	puede tener como único o principal objeto el consumo de los medios de
...
\item \textit{About Digital Evolution} (Avida Wiki:\ 
	...
	¿Te encuentras en un mal estado de ánimo? ¿O crees que tu principal
	problema es
	...
	el ejemplo usual el espectro invisible de luz, pero este es solo uno de
	infinitos
	...
	\textquote{predicen} los datos empíricos).

	Esto lleva al segundo enfoque
	...
	usa en informática para analizar los programas ordinarios.
	...
	Si, como yo, sospechas que Cristo es Dios encarnado, entonces las dos
	opciones que deben tomarse en serio son las siguientes:

	\begin{itemize}
	\item
		El \textbf{catolicismo} (Iglesia Católica) sin
	...
	como los relativistas).
	\textcolor{red}{La razón humana es muy limitada para justificar esta
	verdad absoluta}\footnote{\textcolor{red}{\textit{Nota de 2023}:
	Actualmente no estoy de acuerdo con esto: el
	...
	mostrándose para enseñarnos la verdad acerca de
	Él y su creación. La revelación no puede ser alcanzada por las solas
	fuerzas intelectuales humanas.}}
	\textcolor{red}{y por esto debemos recurrir a la \textquote{revelación}.}
	...
	formación autodidacta y mediocrísima en filosofías erróneas.}.
	...
	por alguna de estas dos variantes, aunque reconocía la herencia
	apostólica auténtica que ambas reciben. En términos de verdad, de
	dogma de fe, son mutuamente excluyentes, hay que decidirse por una
	u otra. Yo estimo cierto (porque así ha sido demostrado) y confío de que
	el catolicismo es la verdadera religión fundada por Jesucristo, el Hijo
	de Dios hecho hombre.}) probablemente sea
	...
	alta religión, con los mejores frutos.

	Que aunque los cristianos no sean
	perfectos, y además admitan de sí mismos que son pecadores, sin ellos
	seríamos \textbf{mucho peores}, o simplemente no \textquote{seríamos}. No
	...
	material solo hay matería y energía, aún así nos quieren convencer de que nos
	...
	experiencia [racional] existe desde la
	consciencia [su facultad intelectual] y esta [facultad] es inmaterial.
	
	Por ejemplo, \textquote{mundo material}
...
%	omnipotencia trascendente de Dios.}},
	es un concepto que utilizamos para referirnos al mundo externo, a los
	objetos
	sensibles, etc. Pero esto no es lo único que existe porque tenemos
	pensamientos, recuerdos, todo tipo de experiencias subjetivas y
	privadas (únicamente accesibles desde el interior del sujeto que las
	experimenta). Y por aquí hay un problema, si dices que todo es
	material, como vas a explicar la consciencia, cómo vas a
	explicar tus
	pensamientos (o tu \textit{qualia}), si ellos no son susceptibles en sí
	mismos a la percepción
	externa de nadie, y por tanto son fenómenos que no están sujetos al
	tratamiento científico-materialista.
	...
	que le dan peso a la \textquote{hipótesis} de la realidad espiritual,
	las
	...
	Esto no es tan importante en general, aunque sí suele serlo al comenzar
	a aprender sobre estos asuntos, porque somos
	demasiado incrédulos. Hay aspectos más importantes, como ya he dicho,
	todo
	el mundo adora algo, lo normal hoy día es que te adoras a ti mismo o adoras las cosas
	...
	construcción social y cosas así.

	Lo más importante de la religión es
	...
	que creer que Cristo era un loco por allí, diciendo que él era Dios,
	que ha sido el único humano en la historia que ha dicho [seriamente] que
	él era Dios, y estos discipulos confiaban tanto en él que dieron la vida
	por él.

	Después tienes al resto de santos y testigos cristianos, hay millones.
	Llevo un año pensando en el sentido de la vida y en cosas como estas, ya
	no me da vergüenza hablar a otros de ello, el mundo que conocía es mucho
	más absurdo que esto. Las cosas que creía que eran obvias, ahora sé que
	son falsas.

	Por eso ahora me animo a hablar de estas cosas. No le tengan miedo a la
	religión aunque la televisión les diga que es mala.
	La verdadera
	...
	primeros cristianos y Cristo que es transmitido por los católicos
%       "(aunque tengan sus grandes faltas)"
	y los ortodoxos\footnote{\textit{Nota de 2023}: Me decidí por el
...
\item La consciencia es primordial\footnote{\textit{Nota de 2023}: El
	...
	materia por sí misma no puede hacer esto porque carece de inteligencia,
	pero sin embargo hay orden, sentido y propósito en el mundo.
	...
	\item El cientificismo (diferente a la ciencia) no funciona porque trabaja bajo
	asunciones fisicalistas que niegan al observador y el propósito de los
	elementos del sistema, sin embargo nuestra vida solo puede ser
	...
	espectro invisible de luz), así mismo hay realidades
	inmateriales que no podemos percibir.
	\item He leído a ateos inteligentes, muchos leen la Biblia fuera del
	...
	También ignoran que el lenguaje de la biblia
	...
	hacer el esfuerzo de entender cómo comprendían los cristianos la
	...
	difamarla con distorsiones y malentendidos sobre su contenido. No todos
	los ateos son así, pero sí muchos, y también hay otros cristianos así.
	...
	de hablar que tuve en este tiempo. Con \textquote{axioma} me refiero a
	un primer
