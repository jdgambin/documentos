...
\begin{document}
	...
	Los textos contenidos en esta colección, que escribí antes de mi
	conversión (en marzo de 2021) al catolicismo y poco tiempo después, son
	de interés \textquote{biográfico} para mí. Los recuerdo como referentes
	en torno al acontecimiento de mi conversión a la fe católica a partir del
	ateísmo agnóstico, substancialmente materialista, individualista y
	hedonista, que sufrí durante más de una década antes de dar los primeros
	pasos en la dirección opuesta. Cuando llegué a Dios todavía conservaba
	muchas inclinaciones malas y excéntricas de mi antiguo pensamiento y
	conducta que quedan plasmadas en estas páginas.

	Solo quiero decir antes de terminar esta introducción que la mejor
	manera de entender la mentalidad católica es viviendo con católicos que
	defiendan y practiquen la recta doctrina y costumbres, haciendo obras de
	caridad espirituales y corporales, obedeciendo al Papa y a las
	autoridades respectivas dentro de la Iglesia, escuchando a buenos
	obispos y sacerdotes, que sean sabios y santos, leyendo la Sagrada
	Escritura, el Catecismo de la Iglesia Católica, los documentos del
	Magisterio eclesiástico y los buenos libros católicos clásicos y
	tradicionales, leyendo  los escritos de los santos y conociendo las
	vidas de los santos y la \textit{verdadera} historia de la Iglesia.
	...
	textos no son tan acertadas, al venir de un nuevo converso, pero el
	...
	ficción, entradas de \textquote{diarios} o publicaciones en hilos de
	foros de internet, otros son transcripciones de mensajes de voz que
	envié a amigos por mensajería instantánea, y así todos tienen orígenes
	y fines diversos. Los escritos de \textquote{conversión}, en especial,
	son textos espontáneos escritos sin esfuerzo de redacción alguno para
	mis amigos y por eso manifiestan un carácter improvisado.
